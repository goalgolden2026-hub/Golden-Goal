  ...
  const slides = [
    {
      ...
      content: (
        <div className="flex flex-col items-center justify-center text-center h-full space-y-8 select-none">
          ...
          <div className="flex items-center gap-3 text-xs tracking-widest text-amber-400/70 font-semibold bg-amber-500/5 px-4 py-2 rounded-full border border-amber-500/10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full max-w-3xl mx-auto">
          <div className="bg-red-500/5 border border-red-500/10 p-5 rounded-2xl space-y-2">
            ...
            <p className="text-zinc-400 text-xs leading-relaxed">
              Casual fans are forced to constantly risk capital just to forecast match outcomes, creating high stress and bad experiences.
            </p>
          </div>
          <div className="bg-red-500/5 border border-red-500/10 p-5 rounded-2xl space-y-2">
            <span className="text-xl">🪘</span>
            ...
            <p className="text-zinc-400 text-xs leading-relaxed">
              Players make predictions in complete isolation. Legacy sites lack SocialFi integration, viral loops, and community rewards.
            </p>
          </div>
          <div className="bg-red-500/5 border border-red-500/10 p-5 rounded-2xl space-y-2">
            <span className="text-xl">🧩</span>
          ...
          <div className="bg-red-500/5 border border-red-500/10 p-5 rounded-2xl space-y-2">
            ...
            <p className="text-zinc-400 text-xs leading-relaxed">
              Most existing Web3 fan tokens lack concrete platform utility sinks or deflationary mechanisms, driving high sell pressure.
            </p>
          </div>
        </div>
      )
        ...
        <div className="space-y-6 w-full max-w-3xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div className="bg-emerald-500/5 border border-emerald-500/10 p-6 rounded-2xl text-center space-y-2">
              ...
              <h4 className="font-bold text-emerald-400 text-sm">Weekly Rewards</h4>
              <p className="text-zinc-400 text-xs leading-relaxed">
                Top 10 analysts on the leaderboards claim weekly token rewards. Skill is directly valued and incentivized.
              </p>
            </div>
            <div className="bg-emerald-500/5 border border-emerald-500/10 p-6 rounded-2xl text-center space-y-2">
              <span className="text-3xl">🧩</span>
              <h4 className="font-bold text-emerald-400 text-sm">Social Growth</h4>
              <p className="text-zinc-400 text-xs leading-relaxed">
                Integrated Social tasks and Twitter Farming generate continuous organic marketing loops for the protocol.
              </p>
            </div>
          </div>
    ...
    {
      title: "The Product",
      subtitle: "High-fidelity, cinematic fan oracle dashboard.",
      type: "product",
      content: (
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full max-w-3xl mx-auto">
          <div className="bg-zinc-900 border border-white/5 p-5 rounded-2xl space-y-3">
            <div className="flex items-center gap-2">
              ...
              <h4 className="font-bold text-white text-sm">Prediction Engine</h4>
            </div>
            <p className="text-zinc-400 text-xs leading-relaxed">
              Enables predictions across 4 core football sub-markets (1X2 Match Outcomes, Correct Score, BTTS, and Under/Over 2.5 goals). Features full modification and cancellation rights before fixtures start.
            </p>
          </div>
          <div className="bg-zinc-900 border border-white/5 p-5 rounded-2xl space-y-3">
            <div className="flex items-center gap-2">
          ...
          <div className="bg-zinc-900 border border-white/5 p-5 rounded-2xl space-y-3">
            <div className="flex items-center gap-2">
              <span className="text-amber-500">📊</span>
              <h4 className="font-bold text-white text-sm">Double Leaderboards</h4>
            </div>
            <p className="text-zinc-400 text-xs leading-relaxed">
              Two concurrent dashboards segmenting competitive play: a <strong>Pro Forecasters</strong> leaderboard for analytical minds, and a <strong>Social Leaderboard</strong> for viral referrers.
            </p>
          </div>
          <div className="bg-zinc-900 border border-white/5 p-5 rounded-2xl space-y-3">
            <div className="flex items-center gap-2">
      ...
      content: (
        <div className="space-y-6 w-full max-w-2xl mx-auto">
          ...
          <div className="p-5 bg-gradient-to-r from-amber-500/10 to-transparent border-l-2 border-amber-500 rounded-r-2xl space-y-2">
            ...
            <p className="text-zinc-400 text-xs leading-relaxed">
              By using Solana, Golden Goal completely bypasses the gas friction and latency associated with legacy blockchains, giving users instant transaction feedbacks and Phantom/Solflare wallet connectivity.
            </p>
          </div>
        </div>
      )
    ...
    },
    {
      ...
      subtitle: "High-performance enterprise cloud architecture for global scale.",
      type: "infrastructure",
      content: (
        <div className="space-y-6 w-full max-w-3xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
            ...
            <div className="bg-zinc-900 border border-white/5 p-5 rounded-xl space-y-2">
              <div className="text-2xl">🏦</div>
              <h4 className="font-bold text-white text-xs">Redundant DB</h4>
              <p className="text-zinc-500 text-[10px]">Fast distributed databases with real-time backups for secure point logging.</p>
            </div>
          </div>
          <div className="bg-gradient-to-r from-amber-500/10 to-transparent border-l-2 border-amber-500 p-4 rounded-r-xl text-left text-xs text-zinc-400 leading-relaxed">
            By choosing AWS, Golden Goal guarantees instant score feeds, fast database write/read queries, and premium cyber defense required for modern global Web3 applications.
          </div>
        </div>
      )
    },
      ...
      content: (
        <div className="grid grid-cols-1 sm:grid-cols-5 gap-3 w-full max-w-4xl mx-auto text-center">
          ...
          <div className="bg-zinc-900/80 border border-amber-500/30 p-4 rounded-xl space-y-1 relative">
            ...
            <div className="text-[10px] text-amber-500 font-bold">PHASE 2</div>
          ...
          <div className="bg-zinc-900/40 border border-white/5 p-4 rounded-xl space-y-1">
            ...
            <div className="text-[9px] text-zinc-500">DAO governance enable, global sports, esports markets.</div>
          </div>
        </div>
      )
    },
