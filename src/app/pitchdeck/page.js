          ...
          <div className="overflow-hidden border border-white/5 rounded-2xl text-[11px]">
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-white/5 bg-zinc-950/40 font-mono">
                <tr><td className="p-3 font-sans text-zinc-300">Tier 0 (Holder)</td><td className="p-3">Min 10,000 GG in Wallet</td><td className="p-3">Base Limit</td><td className="p-3 text-zinc-500">1.0x</td><td className="p-3">100 XP / Open</td></tr>
                <tr><td className="p-3 font-sans text-zinc-300">Tier 1 (Soft)</td><td className="p-3">Min 100 GG (1-Day Lock)</td><td className="p-3 text-emerald-400">+1 Prediction</td><td className="p-3 text-zinc-500">1.0x</td><td className="p-3">75 XP (25% Off)</td></tr>
                <tr><td className="p-3 font-sans text-zinc-300">Tier 2 (7-Day)</td><td className="p-3">Min 500 GG (7-Day Lock)</td><td className="p-3 text-emerald-400">+3 Predictions</td><td className="p-3 text-zinc-500">1.0x</td><td className="p-3">50 XP (50% Off)</td></tr>
                <tr><td className="p-3 font-sans text-zinc-300">Tier 3 (15-Day)</td><td className="p-3">Min 1,000 GG (15-Day Lock)</td><td className="p-3 text-emerald-400">+5 Predictions</td><td className="p-3 text-blue-400">1.1x XP</td><td className="p-3">25 XP (75% Off)</td></tr>
                <tr><td className="p-3 font-sans text-amber-400 font-semibold">Tier 4 (30-Day)</td><td className="p-3 font-bold">Min 5,000 GG (30-Day Lock)</td><td className="p-3 text-emerald-400 font-bold">+10 Predictions</td><td className="p-3 text-blue-400 font-bold">1.25x XP</td><td className="p-3 text-amber-400 font-bold">1 Free Daily Box (then 25 XP)</td></tr>
              </tbody>
            </table>
          </div>
