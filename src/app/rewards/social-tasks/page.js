                        ...
                        <div>
                            ...
                            <div className="bg-black/50 rounded-2xl p-6 border border-zinc-800/60 mb-6">
                                ...
                                <div className="bg-blue-500/5 border border-blue-500/10 p-4 rounded-xl flex items-center justify-between gap-3">
                                    ...
                                    <a 
                                        href={`https://twitter.com/intent/tweet?text=${encodeURIComponent("⚽ The World Cup meta is coming.\n\nAt Golden Goal, users can make football predictions completely free without putting their tokens at risk.\n\nConnect your Solana wallet, predict upcoming matches, climb the leaderboard, and compete for rewards while enjoying the biggest football event on the planet.\n\n🏆 Hold 250,000 $GoldenGoal tokens and receive 3 free predictions every day.\n\nWant more daily predictions? Check out our Power Locking options and unlock additional benefits.\n\n🌐 www.goldengoalsol.com\n\nCA:\nGU527smM71ht8aCA8ouShfXhahVq6crz51FMbfZ8pump\n\n#GoldenGoal #WorldCup2026 #Solana #PredictionMarket #Crypto #Football")}`} 
                                        target="_blank" 
