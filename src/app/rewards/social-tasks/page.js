                        ...
                        <div>
                            ...
                            <div className="bg-black/50 rounded-2xl p-6 border border-zinc-800/60 mb-6">
                                ...
                                <div className="bg-blue-500/5 border border-blue-500/10 p-4 rounded-xl flex items-center justify-between gap-3">
                                    ...
                                    <a 
                                        href={`https://twitter.com/intent/tweet?text=${encodeURIComponent("⏳ Only 3 Days Until the World Cup Begins! ⚽🏆\n\nThe biggest football event on the planet is almost here.\n\nAt Golden Goal, you can test your football knowledge, compete with other fans, climb the leaderboard, and earn rewards — all without spending a single dollar.\n\n✅ Free Predictions\n✅ XP & Leaderboards\n✅ Social Challenges\n✅ Reward Boxes\n✅ World Cup-Focused Experience\n\nNo betting.\nNo entry fees.\nJust football, competition, and fun.\n\nGather your predictions, challenge your friends, and prove you’re the ultimate World Cup analyst.\n\n⚽ Predict.\n📈 Earn XP.\n🏆 Climb the Leaderboard.\n\n$GOLDENGOAL\n\nCA:\nGU527smM71ht8aCA8ouShfXhahVq6crz51FMbfZ8pump\n\nSee you at kickoff.\n\n#GoldenGoal #WorldCup #Solana")}`} 
                                        target="_blank" 
