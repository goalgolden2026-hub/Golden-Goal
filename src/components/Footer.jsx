      ...
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <a 
              href="https://github.com/goalgolden2026-hub/Golden-Goal/tree/zauth-secure-audit" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-zinc-400 hover:text-purple-400 text-xs font-bold transition-all flex items-center gap-2 w-fit hover:translate-x-1"
            >
              <svg className="w-4.5 h-4.5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-1">
              <span className="text-zinc-500 text-[10px] uppercase font-bold tracking-wider flex items-center gap-1.5">
                <svg className="w-3 h-3 text-rose-400 shrink-0" fill="currentColor" fillOpacity="0.15" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
              ...
              <a 
                ...
                className="font-mono text-[10px] text-zinc-300 hover:text-amber-400 transition-colors bg-white/5 hover:bg-white/10 px-2.5 py-1.5 rounded-lg border border-white/5 flex items-center justify-between group break-all"
              >
                <span>5d8SFzxmfymtcKC8hTqrCDpu3Wtbtit8PNrPCLTsr2XF</span>
                <svg className="w-3.5 h-3.5 opacity-50 group-hover:opacity-100 transition-opacity shrink-0 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                </svg>
              </a>
